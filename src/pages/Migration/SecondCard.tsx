...
import { Card, CardHeader, CardBody, Text, Box, Button, Flex, ArrowDownIcon, Link } from '@ggbbest/uikit'
import { Pair } from '@ggbbest/sdk'
      ...
      <CardBody>
        ...
        <Card>
          <CardBody>
            ...
            <Button as={Link} external href="https://hiccup.vpoker.c4ei.net/#/pool" style={{ width: '100%' }}>
              Remove
            </Button>
          </CardBody>
        </Card>
